import { getTagPosts } from "@/lib/tags";
...
export default async function TagPage({
    ...
    const res = await getTagPosts(slug, page);
    ...
    const tagName =
        posts[0]?.tags?.[0]?.name ? posts[0].tags[0].name : slug;
    ...
    return (
        <div className="p-6 max-w-3xl mx-auto space-y-4">
            ...
            <Pagination base={`/tag/${slug}`} pagination={pagination} />
        </div>
    );
}
